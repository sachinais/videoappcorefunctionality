...
import com.nick.sampleffmpeg.utils.Utils;
...
public class DonutProgress extends View {
    ...
    private final int default_unfinished_color = Color.rgb(0, 0, 0);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        unfinishedStrokeWidth = finishedStrokeWidth * 1.5f;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        finishedOuterRect.set(delta,
                ...
                getWidth() - delta,
                getHeight() - delta);
        unfinishedOuterRect.set(delta - 5,
                delta - 5,
                getWidth() - delta ,
                getHeight() - delta);
        ...
        canvas.drawArc(finishedOuterRect, getStartingDegree(), getProgressAngle(), false, unfinishedPaint);
